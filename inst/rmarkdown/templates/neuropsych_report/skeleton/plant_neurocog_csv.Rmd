...
scale_description <- function(data, scale, description) {
  mutate(
    ...
    description = case_when(
      ...
      scale == "Numbers & Letters Part C Efficiency" ~ "`r params$first_name` was given a series of numbers and asked to add them together in a serial manner. This measures working memory, mental flexibility, attention, and numerical processing skills.",
      ...
      scale == "Unstructured Task" ~ "Strategic planning and organization aptitude to formulate an action in advance of performance or intended performance. The task allows the examinee to choose which problems they want to work on to maximize points earned. In doing so, examinees need to plan ahead, avoid items that are strategically poor choices, and be cognizant of when a particular booklet offers diminishing returns.",
      ...
      scale == "TMT, Part B" ~ "On Trails B, which requires more cognitive effort as it involves alternating between number and letter sequences, requiring more cognitive flexibility, divided attention, visual search and scanning, and the ability to maintain and shift cognitive sets",
...
compute_result <- function(data, scale, description, range, result) {
  ...
  phrase_dict <- c(
    ...
    "Nondominant Hand Time" = "fell within the",
    ...
    "D-KEFS Color Naming" = "performed within the",
    "D-KEFS Inhibition" = "fell within the",
    "D-KEFS Switching" = "fell within the",
    "D-KEFS Inhibition Total Errors" = "fell within the",
    "D-KEFS Switching Total Errors" = "fell within the",
    ...
    "Driving Scences" = "fell within the",
