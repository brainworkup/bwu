...
scale_description <- function(data, scale, description) {
  mutate(
    ...
    description = case_when(
      ...
      scale == "Judgment" ~
        "Judgment and decision-making capabilities in situations that are likely to occur in everyday life, with answers assessed for appropriateness, safety, and practicality",
      scale == "Mazes" ~
      ...
      scale == "TMT, Part A" ~ "Visual search speed, scanning, speed of
      processing, and motor speed and coordination on Part A of the Trail Making
      Test",
      scale == "TMT, Part B" ~
      ...
      scale == "D-KEFS Design Fluency Test" ~
        "Executive functioning, generativity, and set-shifting",
