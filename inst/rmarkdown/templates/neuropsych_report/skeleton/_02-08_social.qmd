...
# Flatten the text
bwu::cat_neuropsych_results(data = data_sr, file = "_10_social_raw.qmd")
```

```{r}
#| label: text-social-or
#| cache: true
...
# Flatten the text
bwu::cat_neuropsych_results(data = data_or, file = "_10_social_raw.qmd")
```
    ...
    grid(
      ...
      gutter: 8pt,
        ...
        figure([#image(file_fig, width: auto)],
          caption: [Adult social symptom reports collapsed/averaged together across raters.],
          caption-pos: bottom,
          placement: none,
          kind: "image",
          supplement: [*Fig.*],
...
```{=typst}
#let title = "Self Rating Scales of social and Executive Function"
#let file_qtbl = "table_self_report.png"
#let file_fig = "_10_social_files/figure-typst/fig-caars-1.svg"
#domain(
  title: [#title],
  file_qtbl,
  file_fig
