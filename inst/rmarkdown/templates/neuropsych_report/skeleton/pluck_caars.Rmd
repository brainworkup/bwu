...
table[7, 10] <- c("ADHD Combined")
table[8, 10] <- c("ADHD Combined")
  ...
  table <-
    ...
    dplyr::mutate(
      narrow = dplyr::case_when(
        ...
        scale ==
          "CAARS-SR DSM-5 ADHD Symptoms Total" ~ "ADHD Combined Self-Report",
        scale ==
          "CAARS-SR ADHD Index" ~ "ADHD Combined Self-Report",
        scale ==
  ...
  table <-
    ...
    dplyr::mutate(
      narrow = dplyr::case_when(
        ...
        scale ==
          "CAARS-OR DSM-5 ADHD Symptoms Total" ~ "ADHD Combined Observer-Report",
        scale ==
          "CAARS-OR ADHD Index" ~ "ADHD Combined Observer-Report",
        scale ==
...
```{r write}
file_path <- here::here(params$patient, "csv", paste0(params$test, ".csv"))
