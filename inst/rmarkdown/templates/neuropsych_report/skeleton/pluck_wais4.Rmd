...
table1 <-
  ...
  dplyr::mutate(
    domain = dplyr::case_when(
      ...
      scale == "Full Scale IQ (FSIQ)" ~ "General Cognitive Ability",
...
if (params$version == "brief") {
  table2 <- as.data.frame(plucked_tables[[1]])
...
if (params$version == "brief") {
  table3 <- as.data.frame(plucked_tables[[2]])
} else if (params$version == "full") {
...
if (params$version == "brief") {
  table4 <- as.data.frame(plucked_tables[[3]])
} else if (params$version == "full") {
...
if (params$version == "brief") {
  table5 <- as.data.frame(plucked_tables[[4]])
} else if (params$version == "full") {
...
if (params$version == "brief") {
  table6 <- as.data.frame(plucked_tables[[5]])
} else if (params$version == "full") {
...
if (params$version == "brief") {
  table7 <- as.data.frame(plucked_tables[[6]])
} else if (params$version == "full") {
