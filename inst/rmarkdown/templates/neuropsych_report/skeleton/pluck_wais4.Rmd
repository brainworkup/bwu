...
f <- file.path("/Users/joey/reports/Daniel/pdf/ADHD Young Adult Battery 2024-210a6756-acdd-488e-86e1-1446de4cb331.pdf")

# f <- file.path(file.choose(""))

# locate areas and extract
plucked_tables_wais4 <- tabulizer::extract_areas(
  file = f,
  pages = c(2,3,3,3,3),
  method = "stream",
  output = "matrix"
