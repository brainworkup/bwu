...
#| cache: true
data <- data_iq
bwu::cat_neuropsych_results(data, file = "_02-01_iq_text.qmd")
```
...
grp_iq <- list(
  standard_score = c(
    "Composite Scores", "NAB", "Test of Premorbid Functioning", "WRAT-5",
    "WAIS-IV", "WISC-5"
  )
)
vertical_padding <- 0
...
iq <-
  dplyr::filter(
    ...
    scale %in% c(
      ...
      "Premorbid Ability", "TOPF Standard Score", "Word Reading", "NAB Executive Functions Index"
    )
  )
data <- iq
    ...
    grid(
      ...
      gutter: 8pt,
        ...
        figure([#image(file_fig, width: auto)],
          caption: figure.caption(position: bottom, [_Premorbid Ability_ is an
          estimate of intellectual functioning prior to known or suspected onset
          of brain disease or dysfunction. _Neuropsychological Functioning_
          is the overall skill to reason, solve problems, and gain useful
          knowledge.]),
          placement: none,
          kind: "image",
          supplement: [*Fig.*],
