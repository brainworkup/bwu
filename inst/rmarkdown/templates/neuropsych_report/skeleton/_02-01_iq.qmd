...
grp_iq <- list(
  standard_score = c(
    "Composite Scores", "NAB", "Test of Premorbid Functioning", "WRAT-5", "WAIS-IV", "WISC-5"
  )
)
    ...
    grid(
      ...
      gutter: 8pt,
        ...
        figure([#image(file_fig, width: auto)],
          caption: figure.caption(position: bottom, ["_Premorbid Ability_ is an estimate of intellectual functioning prior to known or suspected onset of brain disease or dysfunction. _General Ability_ is the overall skill to reason, solve problems, and gain useful knowledge. _Crystallized Knowledge_ involves understanding the world through language and reasoning. _Fluid Reasoning_ is the logical analysis and solution of new problems, identifying underlying patterns, and applying logic."]),
          placement: none,
          kind: "image",
          supplement: [*Fig.*],
          gap: 0.5em,
