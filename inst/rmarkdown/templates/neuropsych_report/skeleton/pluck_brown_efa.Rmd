...
# pdf_file <- "/Users/joey/neuropsychology/Georgia/pdf/Brown-EF-A-Scales---Individual-Report_51189762_1693167228924.pdf"
...
```{r areas}
# areas <- tabulizer::locate_areas(file = pdf_file, pages = c(2))
# df <- tabulizer::extract_areas(file = pdf_file, pages = c(2))
```
