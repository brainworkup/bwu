...
library(rmdformats)
library(tibble)
xfun::pkg_load2("pdftools", "tabulizer", "vroom", "tidyverse", "magrittr", "rJava", "shiny")
library(rlang)
library(bwu)
```
...
```{r text-save-dirty}
readr::write_lines(pai_text, here::here("pai_text.md"), sep = "\n")
readr::write_lines(pai_text, here::here("pai_text.qmd"), sep = "\n")
```
...
readr::write_lines(pai_text_squished, here::here("pai_text_squished.qmd"), sep = "\n")
