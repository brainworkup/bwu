...
#| fig-cap: "Overall neurocognitive function subdomain plots of `r params$first_name`'s strengths and weaknesses. *Note:* *z*-scores have a mean of 0 and a standard deviation of 1."
...
#let domain_sirf(file_fig) = {
  ...
  set text(..font)
figure([#image(file_fig, width: 95%)],
  placement: none,
  caption: figure.caption(position: bottom, [Overall neurocognitive function
  subdomain plots of `r params$first_name`'s strengths and weaknesses. _Note:_
...
```{=typst}
#let file_fig = "_03-00_sirf_files/figure-typst/fig-domain-plot-1.svg"
#domain_sirf(
  file_fig
)
```
