...
*High-Hverage*. However, when test results were rescored independent of timing
...
*Below Average* to *Exceptionally Low*. Douglas' history of math difficulties
relates to this broader impairment in nonverbal problem solving.
...
```{r, eval=T}
knitr::read_chunk(here::here("R", "02_make_data.frame_pai.R"))
```

```{r make-df-pai, eval=T, double_escape = T, escape = F}
```
