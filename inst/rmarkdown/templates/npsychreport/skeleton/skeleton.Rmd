...
(ref:basc3-footnote) Score = *T* (M = 50, SD = 10); *Note:* Adaptive
...
An estimate of premorbid verbal ability fell within the *Average* range. Overall intellectual scores were *Average*. Most index scores were *Average* to
...
daily living. `r params$his_her_cap` mother also noted mild concerns with depression. Teacher rating forms were not returned at the time of this report.
...
```{r 05-plot-pai-subdomain, eval=T, fig.margin=TRUE, fig.env='marginfigure', fig.cap='PAI Clinical Domains. Marked elevations were seen on several scales indicating the presence of clinical psychopathology.', fig.height=5, out.width='.5\\textwidth', out.extra='', fig.pos=''}
```

```{r 06-plot-pai-subdomain, eval=F, fig.margin=TRUE, fig.env='marginfigure', fig.cap='PAI Clinical Domains. Marked elevations were seen on several scales indicating the presence of clinical psychopathology.', fig.height=5, out.width='.5\\textwidth', out.extra='', fig.pos=''}
```
...
```{r pai-plot, eval=F, fig.margin=TRUE, fig.env='marginfigure', fig.cap='PAI Clinical Domains. Marked elevations were seen on several scales indicating the presence of clinical psychopathology.', fig.height=5, out.width='.5\\textwidth', out.extra='', fig.pos=''}

dotplot(
  data = df_pai,
  x = df_pai$z_mean_narrow,
  y = df_pai$narrow,
  domain = "personality"
)
```
