...
(ref:acs-topf) Advanced Clinical Solutions (ACS), Test of Premorbid Functioning
(TOPF)
...
(ref:mmpi) Minnesota Multiphasic Personality Inventory-2-Restructured Form
(MMPI-2-RF)
...
(ref:pct) A *percentile* shows `r params$first_name`'s standing relative to
peers. For example, a percentile score of 70 means `r params$first_name`
performed as well as or better than 70% of individuals the same age.
...
(ref:basc3-footnote) Score = *T* (M = 50, SD = 10); *Note:* Adaptive Skills *T*
scores are reversed

(ref:basc3-fn-srp-adol) Score = *T* (M = 50, SD = 10); *Note:* Personal
...
(ref:gc) *Crystallized/verbal intelligence* refers to the ability to learn and use
language to reason and understand how the world works.

(ref:gf) *Fluid/nonverbal intelligence* refers to the ability to use logical reasoning to
...
(ref:gcf) *General cognitive functioning* refers to an overall capacity to
reason, to solve problems, and to learn useful information.
...
research literature is one of "compensated
dyslexia"[@vanviersenHighReadingSkills2016], which is used to describe these
individuals because they use strengths in other areas to compensate for deficits
in reading. Dyslexia is underidentified in this population because the dyslexia
can be masked by strengths in vocabulary and intelligence, making it especially
...
(ref:fn-memory) Score = Standard (M = 100, SD = 15), *T* (M = 50, SD = 10), or
Scaled (M = 10, SD = 3)
...
`r params$first_name` had to execute a series of behavioral responses requiring
her to recognize and interpret the emotional state (happy, sad, angry, afraid,
surprised, disgusted, and neutral) of a series of children's faces, on which
`r params$he_she` performed *above average* overall. `r params$he_she_cap`
performed in the *high-average* range on a measure of pragmatic language and the
ability to comprehend others perspectives, intentions, and beliefs (i.e., theory
of mind).
...
On a self-reported rating scale of attention and executive functioning, Alyssa's
score on *Memory* fell in the *Clinically Significant* range. Alyssa reports
that (ref:he-she) has difficulty utilizing working memory and accessing recall.
Her score on *Focus* fell in the *Clinically Significant* range, reporting that
(ref:he-she) has difficulty focusing, sustaining, and shifting attention to
tasks. Alyssa's score on *Effort* fell in the *At-Risk* range. Alyssa reports
that (ref:he-she) has difficulty regulating alertness, sustaining effort, and
adjusting processing speed. Her score on *Activation* fell in the *At-Risk*
range, noting that she has difficulty organizing, prioritizing, and activating
to work.
...
(ref:domain) *Key Findings:* Verbal skills are significantly stronger than
nonverbal/spatial processing skills. Attentional fluency (i.e., working memory
and processing speed) and abstract reasoning are areas of weakness. Memory
continues to evidence a decline from premorbid levels. *Note:* *z* = 0 (mean) ±
1 (sd)
...
It was a pleasure to work with `r params$first_name`. Please contact me with any
