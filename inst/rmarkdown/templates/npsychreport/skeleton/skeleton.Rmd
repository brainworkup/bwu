...
levels. Written expression was *exceptionally high*[^3]. Reading scores were
*high-average* to *above average*, with strong word reading skills.
`r params$fname`'s composite math score was *high-average*[^4], with
particularly strong math problem solving/quantitative reasoning performance.
...
[^3]: We could not complete the spelling subtest because we ran out of time.

[^4]: `r params$fname` made simple inattentive/careless errors on two math
    calculation problems, lowering his overall score.
...
overall, and `r params$fname` showed a variable learning curve[^5]. Recall of
...
[^5]: He had recalled as many as 14/15 words correctly during the learning
...
5.  Extracurricular activities: Non-academic activities are highly encouraged
