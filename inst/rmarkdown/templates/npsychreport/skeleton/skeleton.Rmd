...
An estimate of premorbid verbal ability fell within the *Average* range. Overall
...
```{r 01-glue-iq, eval=F, double_escape=T, escape=F}
```
...
```{r 05-plot-acad-subdomain, eval=T, double_escape=T, escape=F, fig.cap = '(ref:acad)', fig.path='figures/npsych2-'}
```

```{r 06-plot-acad-narrow, eval=T, double_escape=T, escape=F, fig.cap = '(ref:acad)', fig.path='figures/npsych2-'}
```
