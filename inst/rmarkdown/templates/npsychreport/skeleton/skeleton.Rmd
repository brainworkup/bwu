...
```{r 05-plot-pai-subdomain, eval=F, fig.cap = '(ref:pai)', double_escape=T, escape=F}
```

```{r 06-plot-pai-narrow, eval=F, fig.cap = '(ref:pai)', double_escape=T, escape=F}
```
...
```{r pai-plot, eval=T, fig.margin=TRUE, fig.env='marginfigure', fig.cap='**PAI Clinical Domains**. Marked elevations were seen on several scales indicating the presence of clinical psychopathology.', fig.height=5, out.width='.5\\textwidth', out.extra='', fig.pos=''}
# fig.pos = '!H'
dotplot(
  data = df_pai,
