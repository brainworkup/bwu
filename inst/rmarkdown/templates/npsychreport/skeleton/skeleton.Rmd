...
(ref:fname) `r params$fname`

(ref:lname) `r params$lname`

(ref:heshe) `r params$heshe`

(ref:hisher) `r params$hisher`

(ref:himher) `r params$himher`
...
This seems to be the case for `r params$fname`, as parent ratings indicated significant
attention problems, even with medication. Both parent ratings and `r params$fname`'s own
...
`r params$fname` had to execute a series of behavioral responses requiring her to recognize and interpret the emotional state (happy, sad, angry, afraid, surprised, disgusted, and neutral) of a series of children's faces, on which `r params$he` performed *above average* overall. `r params$he2` performed in the *high-average* range on a measure
...
daily living. `r params$his2` mother also noted mild concerns with depression. Teacher
