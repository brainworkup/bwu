...
out_dir_csv = here::here(patient, "pre_csv")
...
```{r, eval=F, echo=FALSE}
# cognitive is first
cognitive.csv <- file_names_csv[1]
```
...
```{r spt-sub, eval=F, fig.cap = '(ref:spt)', fig.path = 'figures/npsych2-'}
# dotplot make
dotplot(
  data = spt,
  x = spt$z_mean_sub,
...
```{r mem-sub, eval=F, fig.cap = '(ref:mem)', fig.path = 'figures/npsych2-'}
  # dotplot
dotplot(
  data = mem,
