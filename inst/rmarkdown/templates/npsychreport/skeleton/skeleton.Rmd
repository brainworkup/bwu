...
```{r 05-plot-vrb-narrow, eval=T, fig.cap = '(ref:vrb)', double_escape=T, escape=F}
```
...
'r param$fname` had to execute a series of behavioral responses requiring her to recognize and interpret the emotional state (happy, sad, angry, afraid, surprised, disgusted, and neutral) of a series of children's faces, on which she performed
*above average* overall. She performed in the *high-average* range on a measure
...
```{r 05-plot-eq-narrow, eval=T, double_escape = T, escape = F, fig.cap = '(ref:social)', fig.path = 'figures/npsych2-'}
```
