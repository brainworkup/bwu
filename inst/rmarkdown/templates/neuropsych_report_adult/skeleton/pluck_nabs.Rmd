...
table1 <-
  ...
  tidytable::mutate(
    subdomain = tidytable::case_when(
      ...
      scale == "NAB Total Index" ~ "General Cognitive Function",
...
table6 <-
  ...
  tidytable::mutate(
    narrow = tidytable::case_when(
      scale == "Mazes" ~ "Cognitive Efficiency",
...
table1 <-
  ...
  tidytable::mutate(
    description = tidytable::case_when(
      scale ==
        "NAB Total Index" ~
        "Finally, broad neurocognitive functioning (independent of general intelligence) across domains of attentional and executive functioning, language and spatial processing, and learning and memory",
      scale ==
        "NAB Attention Index" ~
