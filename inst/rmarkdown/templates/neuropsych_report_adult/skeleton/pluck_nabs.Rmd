...
```{r save-pdf}
#vroom::vroom_write_lines(file, here::here(patient, "pre_csv", "nabs_pdf"))
```

```{r read-pdf}
#file <- vroom::vroom_read(here::here(patient, "pre_csv", "nabs_pdf"))
```
...
```{r save-areas}
#vroom::vroom_write_lines(area, here::here(patient, "pre_csv", "area_nabs.rds"))
```
...
table3 <-
  ...
  mutate(
    pass = case_when(
      ...
      scale == "Auditory Comprehension Colors" ~ "",
      scale == "Auditory Comprehension Shapes" ~ "",
      scale == "Auditory Comprehension Colors/Shapes/Numbers" ~ "",
...
table6 <-
  ...
  mutate(
    pass = case_when(
      scale == "Mazes" ~ "Planning",
      scale == "Word Generation" ~ "Attention",
...
table2 <-
  ...
  mutate(
    description = case_when(
      ...
      scale == "Numbers & Letters Part A Efficiency" ~ "psychomotor speed, sustained attention, and inhibition",
      scale == "Numbers & Letters Part B Efficiency" ~ "psychomotor speed, information processing speed, divided attention/set-shifting, and inhibition",
      TRUE ~ as.character(description)
    )
  )
```
...
table5 <-
  ...
  mutate(
    description = case_when(
      scale == "Visual Discrimination" ~ "visual perception and discrimination of abstract visual images",
      scale == "Design Construction" ~ "visual construction and integration of abstract visual shapes",
      TRUE ~ as.character(description)
    )
  )
```
