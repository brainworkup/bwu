...
table3 <- tidytable::na_if(table3, "")
table3 <- tidytable::na_if(table3, "NA")
table3 <- tidytable::na_if(table3, "-")
table3 <- tidytable::na_if(table3, "--")
table3 <- tidytable::na_if(table3, "---")
table3 <- tidytable::na_if(table3, "N/A")
to_double <- c("raw_score", "z_score", "score", "percentile")
table3 <-
  table3 |>
...
table4 <- tidytable::na_if(table4, "")
table4 <- tidytable::na_if(table4, "NA")
table4 <- tidytable::na_if(table4, "-")
table4 <- tidytable::na_if(table4, "--")
table4 <- tidytable::na_if(table4, "---")
to_double <- c("raw_score", "z_score", "score", "percentile")
...
table5 <- tidytable::na_if(table5, "")
table5 <- tidytable::na_if(table5, "NA")
table5 <- tidytable::na_if(table5, "-")
table5 <- tidytable::na_if(table5, "--")
table5 <- tidytable::na_if(table5, "---")
to_double <- c("raw_score", "z_score", "score", "percentile")
...
table6 <- tidytable::na_if(table6, "")
table6 <- tidytable::na_if(table6, "NA")
table6 <- tidytable::na_if(table6, "-")
table6 <- tidytable::na_if(table6, "--")
table6 <- tidytable::na_if(table6, "---")
to_double <- c("raw_score", "z_score", "score", "percentile")
...
table2 <-
  ...
  mutate(
    subdomain = case_when(
      ...
      scale %in% nlt ~ "Cognitive Efficiency",
...
table1 <-
  ...
  mutate(
    description = case_when(
      ...
      scale ==
        "NAB Attention Index" ~
        "A composite index of both basic and complex verbal and nonverbal attentional capacity/functioning",
      scale ==
        "NAB Language Index" ~
        "General screening index of expressive/receptive language skills",
      scale ==
        "NAB Memory Index" ~
        "Overall learning efficiency and longer-term memory functioning",
      scale ==
        "NAB Spatial Index" ~
      ...
      scale ==
        ...
        "A composite index of higher executive skills",
