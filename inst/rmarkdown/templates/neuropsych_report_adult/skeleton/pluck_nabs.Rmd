---
title: "Pluck Tables from NAB/NAB Screener"
params:
  patient: "Biggie"
  test:
    label: Test
  ...
  pages: [2,5,6,7,8,8]
  table1:
    label: NAB Index Scores
    value: NAB Attention Index
    input: select
    multiple: yes
    choices:
      - NAB Attention Index
  ...
  table2:
    ...
    choices:
      ...
      - Driving Scenes
  table3:
    label: NAB Language Index
    value: Oral Production
    input: select
    multiple: yes
    choices:
      - Oral Production
      ...
      - Naming
      - Naming Percent Correct After Semantic Cuing
      - Naming Percent Correct After Phonemic Cuing
      ...
      - Bill Payment
  table4:
    label: NAB Memory Index
    value: List Learning Trial 1
    input: select
    multiple: yes
    choices:
      - List Learning Trial 1
      - List Learning Trial 2
      - List Learning Trial 3
      - List Learning Immediate Recall
      - List Learning Trial 4 (List B)
      - List Learning Short Delayed Recall
      - List Learning Long Delayed Recall
      - List Learning Percent Retention
      - List Learning Forced-Choice Recognition
      - List Learning Forced-Choice Recognition False Alarms
      - List Learning Discriminability Index
      - List Learning Semantic Clusters
      - List Learning Perseverations
      - List Learning Instrusions
      ...
      - Shape Learning Forced-Choice Recognition
      - Shape Learning Forced-Choice Recognition False Alarms
      ...
      - Daily Living Memory Delayed Recall vs. Recognition
  ...
  table5:
    ...
    choices:
      ...
      - Figure Drawing Copy Immediate Recall
      - Figure Drawing Copy Immediate Recall Organization
      - Figure Drawing Copy Immediate Recall Fragmentation
      - Figure Drawing Copy Immediate Recall Planning
      - Figure Drawing Copy Immediate Recall Percent Retention
      - Map Reading
  table6:
    label: NAB Executive Functions Index
    value: Mazes
    input: select
    multiple: yes
    choices:
  ...
  colnames1:
    label: Column Names Index Tables
    value: scale
    input: select
    multiple: yes
    choices:
  ...
  colnames2:
    ...
    choices:
      ...
      - category
  colnames3:
    label: Column Names Brief Table
    value: scale
    input: select
    multiple: yes
    choices:
      ...
      - category
  colnames4:
    label: Column Names Primary Score Table
    value: scale
    input: select
    multiple: yes
    choices:
...
```{r save-pdf}
#readr::write_lines(file, here::here(patient, "pre_csv", "nabs_pdf"))
```
...
colnames(table4) <- params$colnames3
...
colnames(table5) <- params$colnames3
