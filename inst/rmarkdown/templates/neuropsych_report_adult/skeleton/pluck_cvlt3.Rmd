...
params:
  ...
  file:
    ...
    value: File
    input: file
  pages: [9,11,9,9,9,12,9] # full [18,20,18,18,18,22,18]
  table1:
...
>>>>>>> 0290d12 (main)
```{r rename2}
# source(here::here("R", "which_cvlt3.R"))
# table2[, 1] <- which_cvlt3(params$test)
table2[, 1] <- c("Trials 1-4 Correct")
```
...
=======
```{r rename7}
table7[, 1] <- c("Forced-Choice Recognition Hits")
>>>>>>> 0290d12 (main)
```
