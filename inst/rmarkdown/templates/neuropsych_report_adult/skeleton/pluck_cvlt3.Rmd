...
```{r save}
writeLines(file, here::here("Reports", patient, "pre_csv", "cvlt3_pdf"))
```
...
```{r save-areas}
saveRDS(area, here::here("Reports", patient, "pre_csv", "area_cvlt3.rds"))
```
...
if (params$test == "cvlt3") {
  readr::write_csv(
    cvlt3,
    here::here("Reports", patient, "csv", "cvlt3.csv")
  )
} else if (params$test == "cvlt3_brief") {
  readr::write_csv(
    cvlt3_brief,
    here::here("Reports", patient, "csv", "cvlt3_brief.csv")
  )
}
```
