...
table3 <-
  ...
  mutate(
    description = case_when(
      ...
      scale ==
        "Long Delay Free Recall" ~
        "Recall of the list after a long delay",
      scale ==
        "Long Delay Cued Recall" ~
        "Recall of the list after a long delay with cues",
      TRUE ~ as.character(description)
    )
  )
```
...
if (params$test == "cvlt3") {
  cvlt3 <-
    dplyr::bind_rows(table1, table2, table3, table4, table5, table6, table7)
} else {
  cvlt3_brief <-
    dplyr::bind_rows(table1, table2, table3, table4, table5, table6, table7)
}
...
```{r cleanup}
rm(area, table, table1, table2, table3, table4, table5, table6, table7)
```
