...
df <- tidytable::tidytable(
  ...
  domainPASS = (params$pass),
  domainVerbal = (params$verbal),
  domainTimed = (params$timed),
  absort =
    paste0(
      tolower(params$test),
  ...
  tidytable::mutate.(.x,
    description = tidytable::case_when.(
      ...
      .scale == "Unstructured Task" ~
        "Planning and organization aptitude to formulate an action in advance of performance or intended performance examined through a 6-minute unstructured task",
    ...
    .x <-
      tidytable::mutate.(
        ...
        result = tidytable::case_when.(
          ...
          .scale == "Unstructured Task" ~
            glue::glue("{.description} fell within the {.range}.\n"),
          .scale == "Letter Fluency" ~
            glue::glue("{.description} was {.range}.\n"),
          .scale == "Category Fluency" ~
            glue::glue("{.description} fell within the {.range}.\n"),
