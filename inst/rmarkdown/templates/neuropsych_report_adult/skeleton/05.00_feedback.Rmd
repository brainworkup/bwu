...
class: left, middle, right bottom
...
```{r drilldown-plot1, fig.cap='Drilldown from broad to narrow domains', fig.width=12, fig.height=8, fig.retina=3, out.width = "100%"}
# Tooltip
...
```{r drilldown-plot2, fig.cap='Drilldown from broad to narrow domains', fig.width=12, fig.height=8, fig.retina=3, out.width = "100%"}
# Tooltip
x <- c("Name", "Score", "Percentile", "Range")
y <- c("{point.name}", "{point.y}", "{point.y2}", "{point.range}")
tt <- highcharter::tooltip_table(x, y)
