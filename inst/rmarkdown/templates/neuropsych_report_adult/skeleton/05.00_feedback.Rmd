...
# 2. sort hi to lo
val1 <- tidytable::arrange(val1, dplyr::desc(mean_percentile))
...
val_level2_drill <-
  lapply(unique(validity$domain), function(x_level) {
    ...
    # 2. sort hi to lo
    val2 <- tidytable::arrange(val2, dplyr::desc(mean_percentile))
...
val_level3_drill <-
  lapply(unique(validity$domain), function(x_level) {
    ...
    lapply(unique(val2$subdomain), function(y_level) {
      ...
      val3 <- tidytable::arrange(val3, dplyr::desc(mean_percentile))
  ...
  lapply(unique(validity$domain), function(x_level) {
    ...
    lapply(unique(val2$subdomain), function(y_level) {
      ...
      lapply(unique(val3$narrow), function(z_level) {
        ...
        val4 <- tidytable::arrange(val4, dplyr::desc(mean_percentile))
