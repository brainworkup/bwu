...
table <-
  ...
  tidytable::mutate(
    domain = tidytable::case_when(
      scale == "Somatic Complaints" ~ "Psychiatric/Axis I",
      scale == "Conversion" ~ "Psychiatric/Axis I",
      scale == "Somatization" ~ "Psychiatric/Axis I",
      scale == "Health Concerns" ~ "Psychiatric/Axis I",
      scale == "Anxiety" ~ "Psychiatric/Axis I",
      scale == "Cognitive (A)" ~ "Psychiatric/Axis I",
      scale == "Affective (A)" ~ "Psychiatric/Axis I",
      scale == "Physiological (A)" ~ "Psychiatric/Axis I",
      scale == "Anxiety-Related Disorders" ~ "Psychiatric/Axis I",
      scale == "Obsessive-Compulsive" ~ "Psychiatric/Axis I",
      scale == "Phobias" ~ "Psychiatric/Axis I",
      scale == "Traumatic Stress" ~ "Psychiatric/Axis I",
      scale == "Depression" ~ "Psychiatric/Axis I",
      scale == "Cognitive (D)" ~ "Psychiatric/Axis I",
      scale == "Affective (D)" ~ "Psychiatric/Axis I",
      scale == "Physiological (D)" ~ "Psychiatric/Axis I",
      scale == "Mania" ~ "Psychiatric/Axis I",
      scale == "Activity Level" ~ "Psychiatric/Axis I",
      scale == "Grandiosity" ~ "Psychiatric/Axis I",
      scale == "Irritability" ~ "Psychiatric/Axis I",
      scale == "Paranoia" ~ "Psychiatric/Axis I",
      scale == "Hypervigilance" ~ "Psychiatric/Axis I",
      scale == "Persecution" ~ "Psychiatric/Axis I",
      scale == "Resentment" ~ "Psychiatric/Axis I",
      scale == "Schizophrenia" ~ "Psychiatric/Axis I",
      scale == "Psychotic Experiences" ~ "Psychiatric/Axis I",
      scale == "Social Detachment" ~ "Psychiatric/Axis I",
      scale == "Thought Disorder" ~ "Psychiatric/Axis I",
      scale == "Aggression" ~ "Psychiatric/Axis I",
      scale == "Aggressive Attitude" ~ "Psychiatric/Axis I",
      scale == "Verbal Aggression" ~ "Psychiatric/Axis I",
      scale == "Physical Aggression" ~ "Psychiatric/Axis I",
      scale == "Suicidal Ideation" ~ "Psychiatric/Axis I",
      scale == "Stress" ~ "Psychiatric/Axis I",
      scale == "Nonsupport" ~ "Psychiatric/Axis I",
      scale == "Treatment Rejection" ~ "Psychiatric/Axis I",
      scale == "Dominance" ~ "Psychiatric/Axis I",
      scale == "Warmth" ~ "Psychiatric/Axis I",
      scale == "Borderline Features" ~ "Personality/Axis II",
      scale == "Affective Instability" ~ "Personality/Axis II",
      scale == "Identity Problems" ~ "Personality/Axis II",
      scale == "Negative Relationships" ~ "Personality/Axis II",
      scale == "Self-Harm" ~ "Personality/Axis II",
      scale == "Antisocial Features" ~ "Personality/Axis II",
      scale == "Antisocial Behaviors" ~ "Personality/Axis II",
      scale == "Egocentricity" ~ "Personality/Axis II",
      scale == "Stimulus-Seeking" ~ "Personality/Axis II",
      scale == "Alcohol Problems" ~ "Drug/Alcohol",
      scale == "Drug Problems" ~ "Drug/Alcohol",
