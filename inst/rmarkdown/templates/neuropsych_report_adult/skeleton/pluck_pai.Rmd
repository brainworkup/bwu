...
# (2) Replace long spaces with a col break symbol
pai_txt_squished <-
...
readr::write_lines(pai_txt_squished, here::here(patient, "pai_text.md"), sep = "\n")

readr::write_lines(pai_txt_squished, here::here(patient, "pai_text.qmd"), sep = "\n")
```
