...
# Est Drug/Alc
df_validity[17, 1] <- c("ALC Estimated Score")
df_validity[18, 1] <- c("DRG Estimated Score")
# Response Set Groups
df_validity[19, 1] <- c("All 'All false'")
df_validity[20, 1] <- c("All 'All mainly true'")
df_validity[21, 1] <- c("All 'All slightly true'")
df_validity[22, 1] <- c("All 'very true'")
df_validity[23, 1] <- c("Fake bad")
df_validity[24, 1] <- c("Fake good")
df_validity[25, 1] <- c("NIM predicted profile")
df_validity[26, 1] <- c("PIM predicted profile")
df_validity[27, 1] <- c("Random responding")
...
df_validity <- df_validity |> tidytable::slice(
  c(
    1:4, 5:10, 11:14, 15:16, 17:18, 19:27
  )
)
```
...
df_validity <- bwu::gpluck_make_columns(
  df_validity,
  raw_score = "",
  range = "",
  ci_95 = "",
...
df_inatt <- bwu::gpluck_make_columns(
  df_inatt,
  raw_score = "",
  range = "",
  ci_95 = "",
