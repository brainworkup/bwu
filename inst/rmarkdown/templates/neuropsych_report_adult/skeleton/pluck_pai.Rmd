...
table <-
  ...
  mutate(
    description = case_when(
      ...
      scale == "Physiological (A)" ~ "high scorers my not psychologically experience themselves as anxious, but show physiological signs that most people associate with anxiety. This reflects a repressive style of dealing with stress. When this subscale is elevated, other somatic symptoms are often observed",
