...
library(tidytable)
library(pdftools)
xfun::pkg_load2("stringi", "pdftools", "tabulizer", "tidytable", "vroom", "pdftables", "qpdf", "tidyverse", "magrittr", "rJava", "shiny", "tabulizerjars", "tidyr", "tidytable", "data.table", "stringr", "rlist", "parallel", "DT")
```
...
plucked_table <-
  tidytable::fread(
    here::here("Reports", patient, "pre_csv", "pariconnectexportPAI.csv")
  )
```
...
readr::write_csv(
  df_clinical,
  here::here("Reports", patient, "csv", "pai_clinical.csv"),
  col_names = TRUE,
  na = ""
)
...
readr::write_csv(
  df_validity,
  here::here("Reports", patient, "csv", "pai_validity.csv"),
  col_names = TRUE,
  na = ""
)
...
readr::write_csv(
  df_inatt,
  here::here("Reports", patient, "csv", "pai_inatt.csv"),
  col_names = TRUE,
  na = ""
)
```
...
pai_txt <- pdftools::pdf_text(file) |>
  stringr::str_split("\n") |>
  unlist()
pai_txt
...
pai_txt_squished <-
  stringr::str_replace_all(pai_txt, "\\s{2,}", "- ") |>
  stringr::str_remove_all(",")
pai_txt_squished

readr::write_lines(pai_txt_squished, here::here("Reports", patient, "pai_text.md"), sep = "\n")
readr::write_lines(pai_txt_squished, here::here("Reports", patient, "pai_text.qmd"), sep = "\n")
```
