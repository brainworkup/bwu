...
if (params$test == "cefi_sr") {
  ...
  table <-
    ...
    tidytable::mutate(
      narrow = tidytable::case_when(
        scale == "Full Scale" ~ "Full Scale (OR)",
        scale == "Attention" ~ "Attention (OR)",
        scale == "Emotion Regulation" ~ "Emotion Regulation (OR)",
        scale == "Flexibility" ~ "Flexibility (OR)",
        scale == "Inhibitory Control" ~ "Inhibitory Control (OR)",
        scale == "Initiation" ~ "Initiation (OR)",
        scale == "Organization" ~ "Organization (OR)",
        scale == "Planning" ~ "Planning",
        scale == "Self-Monitoring" ~ "Self-Monitoring (OR)",
        scale == "Working Memory" ~ "Working Memory (OR)",
        TRUE ~ as.character(narrow)
      )
    )
}
