...
if (params$test == "cefi_sr") {
  table <-
    ...
    tidytable::mutate(
      narrow = tidytable::case_when(
        scale == "Full Scale" ~ "Full Scale (Self)",
        scale == "Attention" ~ "Attention (Self)",
        scale == "Emotion Regulation" ~ "Emotion Regulation (Self)",
        scale == "Flexibility" ~ "Flexibility (Self)",
        scale == "Inhibitory Control" ~ "Inhibitory Control (Self)",
        scale == "Initiation" ~ "Initiation (Self)",
        scale == "Organization" ~ "Organization (Self)",
        scale == "Planning" ~ "Planning (Self)",
        scale == "Self-Monitoring" ~ "Self-Monitoring (Self)",
        scale == "Working Memory" ~ "Working Memory (Self)",
  ...
  table <-
    ...
    tidytable::mutate(
      narrow = tidytable::case_when(
        scale == "Full Scale" ~ "Full Scale (Observer)",
        scale == "Attention" ~ "Attention (Observer)",
        scale == "Emotion Regulation" ~ "Emotion Regulation (Observer)",
        scale == "Flexibility" ~ "Flexibility (Observer)",
        scale == "Inhibitory Control" ~ "Inhibitory Control (Observer)",
        scale == "Initiation" ~ "Initiation (Observer)",
        scale == "Organization" ~ "Organization (Observer)",
        scale == "Planning" ~ "Planning (Observer)",
        scale == "Self-Monitoring" ~ "Self-Monitoring (Observer)",
        scale == "Working Memory" ~ "Working Memory (Observer)",
        TRUE ~ as.character(narrow)
      )
    )
}
