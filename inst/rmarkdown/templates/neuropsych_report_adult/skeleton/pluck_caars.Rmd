...
```{r pluck1}
table1 <- tidytable::as_tibble(plucked_table[[1]])
...
table1 <- tidytable::na_if(table1, "--")
table1 <- tidytable::na_if(table1, "---")
table1 <- tidytable::na_if(table1, "N/A")
```
...
table2 <- tidytable::na_if(table2, "--")
table2 <- tidytable::na_if(table2, "---")
table2 <- tidytable::na_if(table2, "N/A")
...
```{r pluck3}
table3 <- tidytable::as_tibble(plucked_table[[3]])
...
table <- table %>% tidytable::select(all_of(keep))
```
...
```{r relocate}
table <- table |> tidytable::relocate(c(raw_score, score, percentile, range, ci_95),
  .before = test
)
```
