...
if (params$test == "caars_sr") {
  ...
  table <-
    ...
    tidytable::mutate(
      narrow = tidytable::case_when(
        scale ==
          "Inattention/Memory Problems" ~ "Inattention/Memory Problems (OR)",
        scale ==
          "Hyperactivity/Restlessness" ~ "Hyperactivity/Restlessness (OR)",
        scale ==
          "Impulsivity/Emotional Lability" ~ "Impulsivity/Emotional Lability (OR)",
        scale ==
          "Problems with Self-Concept" ~ "Problems with Self-Concept (OR)",
        scale ==
          "DSM-5 Inattentive Symptoms" ~ "DSM-5 Inattentive Symptoms (OR)",
        scale ==
          "DSM-5 Hyperactive-Impulsive Symptoms" ~ "DSM-5 Hyperactive-Impulsive Symptoms (OR)",
        scale ==
          "DSM-5 ADHD Symptoms Total" ~ "DSM-5 ADHD Symptoms Total (OR)",
        scale ==
          "ADHD Index" ~ "ADHD Index (OR)",
        TRUE ~ as.character(narrow)
      )
    )
}
