...
# Function to extract text between Ashish and Joey Trampush
extract_text <- function(file_path, start_pattern, end_pattern) {
...
file_path <- paste("~/neuropsychological.reports/", patient, file)

# Call the function and print the extracted text
extracted_text <- 
  extract_text(file_path, patient, "Joey Trampush") |> 
  stringr::str_squish()
...
# output_path <- "path/to/your/output_file.md"
...
Attention and Concentration: able to sustain attention and concentration
throughout the interview; no signs of distractibility or
difficulties with task-switching.

Language: exhibited fluent and clear speech, with appropriate syntax and
grammar. No signs of aphasia, dysarthria, or anomia. Patient was able to
comprehend and follow verbal instructions.

Memory: able to recall recent and remote events without difficulty. No signs of amnesia or confabulation.

Executive Functioning: intact, with the ability to plan, initiate, and complete tasks without difficulty. No signs of impulsivity, perseveration, or difficulties with decision-making.

Mood and Affect: mood was euthymic and affect was appropriate throughout the
interview. No outwardly signs of anxiety, depression, or mania.

## Summary/Impression

Overall, the current neurobehavioral exam can be used as a starting point for a
more comprehensive neuropsychological evaluation. Evaluation will provide an
overview of the patient's cognitive, behavioral, academic, and emotional
functioning. Results will help guide further assessment and treatment planning.
