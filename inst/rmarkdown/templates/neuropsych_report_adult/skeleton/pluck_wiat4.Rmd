...
table1 <- dplyr::mutate(table1, raw_score = NA_integer_, .before = V2)
...
table2 <- dplyr::mutate(table2, raw_score = NA_integer_, .before = V2)
...
table <-
  ...
  mutate(
    description = case_when(
      ...
      scale == "Pseudoword Decoding" ~ "phonic decoding skills by reading aloud a list of pseudowords",
