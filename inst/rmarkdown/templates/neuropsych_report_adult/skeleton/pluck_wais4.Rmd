...
table1 <-
  ...
  dplyr::mutate(
    description = dplyr::case_when(
      ...
      scale == "Processing Speed (PSI)" ~ "The PSI provides an estimate of Processing Speed (Gs). Gs refers to the efficiency of cognitive processing or speed of mental activity. It involves the ability to perform simple clerical-type tasks quickly, especially when under pressure to maintain attention and concentration. The PSI of 90 (85-95) is classified as Average and is ranked at the 25th percentile, indicating performance as good as or better than 25% of same age peers from the general population.",
