...
```{r wfile}
#vroom::vroom_write_lines(file, here::here(patient, "pre_csv", "wais4_pdf"))
```

```{r rfile}
#file <- vroom::vroom_read(here::here(patient, "pre_csv", "wais4_pdf"))
```
...
```{r w-area}
#vroom::vroom_write_lines(area, here::here(patient, "pre_csv", "area_wais4.rds"))
```
