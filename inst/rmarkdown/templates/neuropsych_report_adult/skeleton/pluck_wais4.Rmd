...
```{r write-file}
writeLines(file, here::here("Reports", patient, "pre_csv", "wais4_pdf"))
```
...
```{r write-area}
saveRDS(area, file = here::here("Reports", patient, "pre_csv", "area_wais4.rds"), compress = FALSE)
```
...
```{r write}
readr::write_csv(wais4, here::here("Reports", patient, "csv", "wais4.csv"))
```
