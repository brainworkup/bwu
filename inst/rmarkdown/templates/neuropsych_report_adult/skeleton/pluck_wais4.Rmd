...
table4 <-
  ...
  dplyr::mutate(
    description = dplyr::case_when(
      ...
      scale == "Letter-Number Sequencing" ~ "Working memory maintenance and resequencing of progressively lengthier number and letter strings in working memory",
      TRUE ~ as.character(description)
    )
  )
```
...
table7 <-
  ...
  dplyr::mutate(
    description = dplyr::case_when(
      scale == "Digit Span Forward" ~ "Forward digit span/attention span",
