...
`r params$firstname` `r params$lastname` is a `r params$age`-year-old `r params$sex` referred for evaluation by `r params$refdoc` to assess `r params$his_her` current cognitive and
