...
Patient is currently a USC student completing their $degree degree in $major. `r params$first_name` did not endorse any difficulties with advancing through school.
