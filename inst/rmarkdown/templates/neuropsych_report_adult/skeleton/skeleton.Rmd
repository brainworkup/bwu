...
```{r 02-glue-iq, eval = params$eval_iq, cache=TRUE, cache.path='cache/'}
```

```{r 03-table-iq, eval = params$eval_iq}
```

```{r 04-kable-iq, eval = params$eval_iq, double_escape=T, escape=F, fig.fullwidth=T}
```
...
```{r 02-glue-academics, eval = params$eval_academics, cache=TRUE, cache.path='cache/'}
```
...
```{r 02-glue-spatial, eval = params$eval_spatial, cache=TRUE, cache.path='cache/'}
```
...
```{r 02-glue-motor, eval = params$eval_motor, cache=TRUE, cache.path='cache/'}
```
...
```{r 02-glue-social, eval = params$eval_social, cache=TRUE, cache.path='cache/'}
```
...
```{r 02-glue-adhd, eval = params$eval_adhd, cache=TRUE, cache.path='cache/'}
```
...
```{r 02-glue-emotion, eval = params$eval_emotion, cache=TRUE, cache.path='cache/'}
```

```{r 03-table-emotion, eval = params$eval_emotion}
```

```{r 04-kable-emotion, eval = params$eval_emotion, double_escape=T, escape=F, fig.fullwidth=T}
```
