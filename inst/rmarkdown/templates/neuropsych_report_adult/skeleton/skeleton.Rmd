...
```{r, make-factors-neurocog, cache = TRUE}
...
```{r, make-factors-neurobehav, cache = TRUE}
...
```{r 01-filter-iq, eval = params$eval_iq, cache = TRUE}
```

```{r 02-glue-iq, eval = params$eval_iq, cache=TRUE}
```

```{r 03-table-iq, eval = params$eval_iq, cache = TRUE}
```

```{r 04-kable-iq, eval = params$eval_iq, double_escape = TRUE, escape = FALSE, fig.fullwidth = TRUE, cache = TRUE}
```

```{r 05-df-iq, eval = params$eval_iq, cache = TRUE}
```

```{r 06-plot-subdomain-iq, eval = params$eval_iq, fig.cap = '(ref:g) (ref:gc) (ref:gf)', cache = TRUE}
```

```{r 07-plot-narrow-iq, eval = FALSE, fig.cap = '(ref:g) (ref:gc) (ref:gf)', cache = TRUE}
```
...
```{r 04-kable-academics, eval = params$eval_academics, double_escape = T, escape = F, fig.fullwidth = TRUE}
```
...
```{r 02-glue-verbal, eval = params$eval_verbal, cache = TRUE, cache.path = 'cache/'}
```
...
```{r 04-kable-spatial, eval = params$eval_spatial, double_escape= T , escape = F, fig.fullwidth = TRUE}
```
...
```{r 02-glue-executive, eval = params$eval_executive, cache = TRUE, cache.path = 'cache/'}
```

```{r 03-table-executive, eval = params$eval_executive}
```

```{r 04-kable-executive, eval = params$eval_executive, double_escape = T, escape = F, fig.fullwidth = TRUE}
```
...
```{r 02-glue-memory, eval = params$eval_memory, cache = TRUE, cache.path = 'cache/'}
```

```{r 03-table-memory, eval = params$eval_memory}
```

```{r 04-kable-memory, eval = params$eval_memory, double_escape = T, escape = F, fig.fullwidth = TRUE}
```
...
```{r 04-kable-motor, eval = params$eval_motor, double_escape=T, escape=F, fig.fullwidth = TRUE}
```
...
```{r 04-kable-social, eval = params$eval_social, double_escape=T, escape=F, fig.fullwidth = TRUE}
```
...
```{r 02-glue-adhd, eval = params$eval_adhd, cache=TRUE}
```

```{r 03-table-adhd, eval = params$eval_adhd}
```

```{r 04-kable-adhd, eval = params$eval_adhd, double_escape=T, escape=F, fig.fullwidth=T}
```

```{r 05-df-adhd, eval = params$eval_adhd}
```

```{r 06-plot-adhd-adhd, eval = params$eval_adhd, fig.cap='(ref:adhd-ef)'}
```
...
```{r domain-plot, fig.cap = '(ref:domain)', fig.height = 3.5, cache = TRUE}
bwu::dotplot(
  data = domain,
  x = domain$z_mean_dom,
  y = domain$domain,
...
```{r pass-plot, eval = T, fig.cap = '(ref:pass)', fig.env = 'marginfigure', fig.height = 5, out.width = '.5\\textwidth', out.extra = '', fig.pos = '', cache = TRUE}
bwu::dotplot(
  data = pass,
  x = pass$z_mean_pass,
  y = pass$pass,
...
```{r nonverbal-plot, eval = T, fig.cap = '(ref:nonverbal)', fig.env = 'marginfigure', fig.height = 5, out.width = '.5\\textwidth', out.extra = '', fig.pos = '', cache = TRUE}
bwu::dotplot(
  data = nonverbal,
...
```{r timed-plot, eval = T, fig.cap = '(ref:timed)', fig.env='marginfigure', fig.height=5, out.width='.5\\textwidth', out.extra='', fig.pos='', cache = TRUE}
bwu::dotplot(
  data = timed,
...
```{r, sirf, results = 'asis', cache = TRUE}
...
```{r, recs, results = 'asis', cache = TRUE}
