...
```{r 02-glue-iq, double_escape=T, escape=F, cache=TRUE, cache.path='cache/'}
```

```{r 03-table-iq}
```

```{r 04-kable-iq, double_escape=T, escape=F, fig.fullwidth=T}
```
...
```{r 01-filter-academics}
```

```{r 02-glue-academics, double_escape=T, escape=F, cache=TRUE, cache.path='cache/'}
```

```{r 03-table-academics, double_escape=T, escape=F}
```

```{r 04-kable-academics, double_escape=T, escape=F, fig.fullwidth=T}
```

```{r 05-df-academics, double_escape=T, escape=F}
```
...
```{r 02-glue-verbal, double_escape=T, escape=F, cache=TRUE, cache.path='cache/'}
```

```{r 03-table-verbal, double_escape=T, escape=F}
```


```{r 04-kable-verbal, double_escape=T, escape=F}
```

```{r 05-df-verbal, double_escape=T, escape=F}
```
...
```{r 01-filter-spatial, double_escape=T, escape=F}
```

```{r 02-glue-spatial, double_escape=T, escape=F, cache=TRUE, cache.path='cache/'}
```

```{r 03-table-spatial, double_escape=T, escape=F}
```

```{r 04-kable-spatial, double_escape=T, escape=F}
```

```{r 05-df-spatial, double_escape=T, escape=F}
```
...
```{r 01-filter-executive}
```

```{r 02-glue-executive, double_escape=T, escape=F, cache=TRUE, cache.path='cache/'}
```


```{r 03-table-executive, double_escape=T, escape=F}
```

```{r 04-kable-executive, double_escape=T, escape=F}
```

```{r 05-df-executive, double_escape=T, escape=F}
```
...
```{r 02-glue-memory, double_escape=T, escape=F, cache=TRUE, cache.path='cache/'}
```

```{r 03-table-memory, double_escape=T, escape=F}
```

```{r 04-kable-memory, double_escape=T, escape=F}
```

```{r 05-df-memory, double_escape=T, escape=F}
```
...
```{r 02-glue-motor, double_escape=T, escape=F, cache=TRUE, cache.path='cache/'}
```

```{r 03-table-motor, double_escape=T, escape=F}
```

```{r 04-kable-motor, double_escape=T, escape=F}
```

```{r 05-df-motor, double_escape=T, escape=F}
```
...
```{r 02-glue-social, double_escape=T, escape=F, cache=TRUE, cache.path='cache/'}
```

```{r 03-table-social, double_escape=T, escape=F}
```

```{r 04-kable-social, double_escape=T, escape=F}
```

```{r 05-df-social, double_escape=T, escape=F}
```

```{r 06-plot-subdomain-social, eval=F, fig.cap = '(ref:soc-cog)', double_escape=T, escape=F}
```

```{r 07-plot-narrow-social, eval=T, fig.cap = '(ref:soc-cog)', double_escape=T, escape=F}
```
