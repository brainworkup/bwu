...
```{r, write-data}
readr::write_csv(neuropsych, here::here(patient, "neuropsych.csv"), show_col_types = FALSE)
readr::write_csv(neurocog, here::here(patient, "neurocog.csv"), show_col_types = FALSE)
readr::write_csv(neurobehav, here::here(patient, "neurobehav.csv"), show_col_types = FALSE)
```

```{r, read-data}
neuropsych <- readr::read_csv(here::here(patient, "neuropsych.csv"), show_col_types = FALSE)
neurocog <- readr::read_csv(here::here(patient, "neurocog.csv"), show_col_types = FALSE)
neurobehav <- readr::read_csv(here::here(patient, "neurobehav.csv"), show_col_types = FALSE)
```
