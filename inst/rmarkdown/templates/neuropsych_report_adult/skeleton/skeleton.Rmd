...
scores are easiest to interpret as percentiles^[(ref:pct)], which are provided
in the tables below, and as *z*-scores (M = 0, SD = 1)^[(ref:zplot)], which are
used to plot the various test and domain scores below.
