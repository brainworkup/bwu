...
```{r nse, results = 'asis', cache = TRUE}
cat(readLines("1.2_nse.md"), sep = "\n")
```
...
```{r nt-obs, results = 'asis', cache = TRUE}
cat(readLines("2.1_nt-obs.md"), sep = "\n")
```
...
```{r, read-extra, cache = F, eval=FALSE}
patient <- params$patient

read_extra <- function(patient, test) {
  test <- 
...
examiner <- read_extra(patient, "examiner.csv")
pegboard <- read_extra(patient, "pegboard.csv")
rocf <- read_extra(patient, "rocf.csv")
topf <- read_extra(patient, "topf.csv")
wiat4 <- read_extra(patient, "wiat4.csv")

readr::write_csv(examiner, here::here(patient, "csv", "examiner.csv"))
readr::write_csv(pegboard, here::here(patient, "csv", "pegboard.csv"))
readr::write_csv(rocf, here::here(patient, "csv", "rocf.csv"))
readr::write_csv(topf, here::here(patient, "csv", "topf.csv"))
...
```{r, make-factors-neurocog, cache = F}
...
```{r, make-factors-neurobehav, cache = F}
...
cat(readLines("2.2_iq.md"), sep = "\n")
```

```{r read-iq, eval = params$eval_iq}
knitr::read_chunk(here::here(patient, "2.2_iq.R"))
```
...
```{r 07-plot-narrow-iq, eval = FALSE, fig.cap = '(ref:g) (ref:gc) (ref:gf)'}
```
...
cat(readLines("2.3_academics.md"), sep = "\n")
```

```{r read-academics, eval = params$eval_academics}
knitr::read_chunk(here::here(patient, "2.3_academics.R"))
```
...
```{r 07-plot-narrow-academics, eval = F, fig.cap = '(ref:acad)'}
```
...
cat(readLines("2.4_verbal.md"), sep = "\n")
```

```{r read-verbal, eval = params$eval_verbal}
knitr::read_chunk(here::here(patient, "2.4_verbal.R"))
```
...
```{r 06-plot-subdomain-verbal, eval = F, fig.cap = '(ref:vrb)'}
```
...
cat(readLines("2.5_spatial.md"), sep = "\n")
```

```{r read-spatial, eval = params$eval_spatial}
knitr::read_chunk(here::here(patient, "2.5_spatial.R"))
```
...
```{r 06-plot-subdomain-spatial, eval = F, fig.cap = '(ref:spt)'}
```
...
cat(readLines("2.6_executive.md"), sep = "\n")
```

```{r read-executive, eval = params$eval_executive}
knitr::read_chunk(here::here(patient, "2.6_executive.R"))
```
...
```{r 07-plot-narrow-executive, eval=F, fig.cap = '(ref:att-exe)'}
```
...
cat(readLines("2.7_memory.md"), sep = "\n")
```

```{r read-memory, eval = params$eval_memory}
knitr::read_chunk(here::here(patient, "2.7_memory.R"))
```
...
```{r 06-plot-subdomain-memory, eval = F, fig.cap = '(ref:mem)'}
```
...
cat(readLines("2.8_motor.md"), sep = "\n")
```

```{r read-motor, eval = params$eval_motor}
knitr::read_chunk(here::here(patient, "2.8_motor.R"))
```
...
```{r 06-plot-subdomain-motor, eval=F, fig.cap = '(ref:mtr)'}
```
...
cat(readLines("2.9_social.md"), sep = "\n")
```

```{r read-social, eval = params$eval_social}
knitr::read_chunk(here::here(patient, "2.9_social.R"))
```
...
cat(readLines("2.10_adhd.md"), sep = "\n")
```

```{r read-adhd, eval = params$eval_adhd}
knitr::read_chunk(here::here(patient, "2.10_adhd.R"))
```
...
```{r 06-plot-adhd-adhd, eval = params$eval_adhd, fig.cap='(ref:caars)'}
```

```{r 07-df-adhd, eval = params$eval_adhd}
```

```{r 08-plot-executive-adhd, eval = params$eval_adhd, fig.cap='(ref:att-ef)'}
```
...
cat(readLines("2.11_emotion.md"), sep = "\n")
```

```{r read-emotion, eval = params$eval_emotion}
knitr::read_chunk(here::here(patient, "2.11_emotion.R"))
```
...
```{r 06-plot-subdomain-emotion, eval = params$eval_emotion, fig.cap='(ref:emotion)'}
```

```{r 07-plot-narrow-emotion, eval = F, fig.cap='(ref:emotion)'}
```
...
```{r pass-plot, eval = T, fig.cap = '(ref:pass)', fig.env = 'marginfigure', fig.height = 5, out.width = '.5\\textwidth', out.extra = '', fig.pos = ''}
bwu::dotplot(
  data = pass,
  x = pass$z_mean_pass,
  y = pass$pass,
...
```{r nonverbal-plot, eval = T, fig.cap = '(ref:nonverbal)', fig.env = 'marginfigure', fig.height = 5, out.width = '.5\\textwidth', out.extra = '', fig.pos = ''}
bwu::dotplot(
  data = nonverbal,
...
```{r timed-plot, eval = T, fig.cap = '(ref:timed)', fig.env='marginfigure', fig.height=5, out.width='.5\\textwidth', out.extra='', fig.pos=''}
bwu::dotplot(
  data = timed,
...
```{r ranges, double_escape = TRUE, escape = FALSE, fig.fullwidth = FALSE, cache = TRUE}
