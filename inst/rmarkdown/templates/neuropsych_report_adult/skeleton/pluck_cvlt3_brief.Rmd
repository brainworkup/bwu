...
```{r save}
readr::write_lines(file, here::here(patient, "pre_csv", "cvlt3_brief_pdf"))
```

```{r read}
#file <- readr::read_lines(here::here(patient, "pre_csv", "cvlt3_brief_pdf"))
```
...
```{r save-areas}
#readr::write_rds(area, here::here(patient, "pre_csv", "area_cvlt3_brief.rds"))
```

```{r read-areas}
#area <- readr::read_rds(here::here(patient, "pre_csv", "area_cvlt3_brief.rds"))
```
