...
```{r, write-data}
vroom::vroom_write(neuropsych, here::here(patient, "neuropsych.csv"), delim = ",")
vroom::vroom_write(neurocog, here::here(patient, "neurocog.csv"), delim = ",")
vroom::vroom_write(neurobehav, here::here(patient, "neurobehav.csv"), delim = ",")
```
