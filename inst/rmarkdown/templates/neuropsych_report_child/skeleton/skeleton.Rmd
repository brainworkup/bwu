...
(ref:acs-word-choice) ACS Word Choice Test

(ref:acs-soc-cog) ACS Social Cognition Battery

(ref:acs-topf) ACS Test of Premorbid Functioning (TOPF)
...
(ref:basc3-trs-preschool) BASC-3 Teacher Rating Scale (TRS), Preschool

(ref:basc3-trs-child) BASC-3 Teacher Rating Scale (TRS), Child

(ref:basc3-trs-adolescent) BASC-3 Teacher Rating Scale (TRS), Adolescent
...
-   (ref:basc3)
  -   (ref:basc3-sdh)
  -   (ref:basc3-prs-preschool)
  -   (ref:basc3-prs-child)
  -   (ref:basc3-prs-adolescent)
  -   (ref:basc3-trs-preschool)
  -   (ref:basc3-trs-child)
  -   (ref:basc3-trs-adolescent)
  -   (ref:basc3-srp-child)
...
neuropsych <-
  ...
  purrr::set_names() %>%
  purrr::map_df(
    ~ vroom::vroom(file.path(data_path, .), show_col_types = FALSE),
    na = c("", "NA", "--", "-"),
    .id = "filename"
  ) %>%
  dplyr::distinct() %>%
...
```{r, write-data}
vroom::vroom_write(neuropsych, here::here(patient, "neuropsych.csv"))
vroom::vroom_write(neurocog, here::here(patient, "neurocog.csv"))
vroom::vroom_write(neurobehav, here::here(patient, "neurobehav.csv"))
```
...
range <- vroom::vroom(here::here(patient, "test_score_ranges.csv"), show_col_types = FALSE)
gt::gt(range) %>%
