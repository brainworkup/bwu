...
(ref:fn-adhd) *T* Score (M = 50, SD = 10)
...
```{r 03-table-adhd, eval=T, double_escape=T, escape=F, cache=TRUE, cache.path='cache/'}
```
...
```{r 04-kable-adhd, eval=T, double_escape=T, escape=F, fig.fullwidth=T, cache=TRUE, cache.path='cache/'}
```
...
```{r 05-df-adhd, eval=T, double_escape=T, escape=F, cache=TRUE, cache.path='cache/'}
```
...
```{r 06-plot-narrow-adhd, eval=T, double_escape=T, escape=F, fig.cap='(ref:adhd-ef)', cache=TRUE, cache.path='cache/'}
```
...
```{r 06-plot-subdomain-emotion, eval=T, double_escape=T, escape=F, fig.cap='(ref:emotion)'}
```
