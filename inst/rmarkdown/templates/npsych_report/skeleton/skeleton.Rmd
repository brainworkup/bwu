...
```{r 02-glue-academics, eval=F, double_escape=T, escape=F}
```
...
```{r 03-table-academics, eval=T, double_escape=T, escape=F, fig.fullwidth=T}
```
...
```{r 04-kable-academics, eval=T, double_escape=T, escape=F}
```
