...
```{r 07-plot-narrow-adhd, eval=F, double_escape=T, escape=F, fig.cap = 'Ratings of executive and attentional functioning related to ADHD in everyday life.'}
```
...
(ref:emotion) Write something about emotion and personality.
...
(ref:pass) Planning, Attention, Successive, and Simultaneous Processing (PASS) Model
