...
```{r 06-plot-subdomain-executive, eval=F, fig.cap = '(ref:exe)', double_escape=T, escape=F}
```
...
```{r 07-plot-narrow-executive, eval=T, fig.cap = '(ref:exe)', double_escape=T, escape=F}
```
...
```{r 06-plot-subdomain-adhd, eval=F, double_escape=T, escape=F, fig.cap = 'Ratings of executive and attentional functioning related to ADHD in everyday life.'}
```

```{r 07-plot-narrow-adhd, eval=T, double_escape=T, escape=F, fig.cap = 'Ratings of executive and attentional functioning related to ADHD in everyday life.'}
```
