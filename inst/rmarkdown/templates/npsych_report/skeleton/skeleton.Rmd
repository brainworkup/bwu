...
(ref:basc3-footnote) *T* Score (M = 50, SD = 10); *Note:* Adaptive Skills *T* scores are reversed

(ref:basc3-fn-srp-adol) *T* Score (M = 50, SD = 10); *Note:* Personal Adjustment *T* scores are reversed
...
neurocog <-
  ...
  dplyr::mutate(
    result = glue::glue(
      "{patient}'s score on {scale},
       a measure of {description},
        fell in the *{}range}* range (PR = {percentile})."))
```
...
```{r, eval=T}
knitr::read_chunk(here::here(patient, "nt_iq.R"))
```
...
(ref:fn-verbal) Standard Score (M = 100, SD = 15), *T* Score (M = 50, SD = 10), or Scaled Score (M = 10, SD = 3)
...
(ref:fn-spatial) Standard Score (M = 100, SD = 15), *T* Score (M = 50, SD = 10), or Scaled Score (M = 10, SD = 3)
...
(ref:fn-motor) *T* Score (M = 50, SD = 10) or Scaled Score (M = 10, SD = 3)
