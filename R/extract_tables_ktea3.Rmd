...
```{r Setup, eval=TRUE, include=FALSE, message=FALSE, warning=FALSE, echo=FALSE}
...
ktea3_orig <-
  read_csv(
    here::here("04_DTF", "kb", "csv", "ktea3.csv"),
    col_types = cols(
...
## write out final csv
readr::write_csv(ktea3, here("04_DTF", "kb", "csv", "ktea3-kb.csv", col_names = TRUE, na = ""))
