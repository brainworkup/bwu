...
# Add/mutate columns
ktea3 <- dplyr::mutate(ktea3, range = "", test = "ktea3", test_name = "KTEA-3", domain = "", subdomain = "", subdomain_narrow = "", domain_broad = "Academics", domain_test = "", test_type = "npsych_test", score_type = "standard_score", timed = "", absort = paste0("KTEA3_",1:49))
